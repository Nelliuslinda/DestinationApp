...
import com.example.cart_firebase.adapter.MyCartAdapter;
...
public class CartActivity extends AppCompatActivity implements iCartLoadListener {
        ...
        FirebaseDatabase.getInstance()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        {
                            cartLoadListener.onCartLoadFailed("Cart is empty");
                        }
                    }
    ...
    public void onCartLoadSuccess(List<CartModel> cartModelList) {
        ...
        txtTotal.setText(new StringBuilder("KES ").append(sum));
